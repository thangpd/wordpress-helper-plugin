...
//		$this->dom        = $this->stringFilter( $this->stringyfyCrawledData() );
	...
	function enqueue_script( $hook ) {
		wp_register_script( 'elhelper-shortcode-js', plugins_url( '/assets/elhelper/js/elhelper-plugin.js', __FILE__ ), array( 'jquery' ) );
		wp_register_style( 'elhelper-shortcode-css', plugins_url( '/assets/elhelper/css/elhelper-plugin.css', __FILE__ ) );
	}
	...
	function wporg_shortcode( $atts = [], $content = null ) {
		...
		wp_enqueue_script( 'elhelper-shortcode-js' );
		wp_enqueue_style( 'elhelper-shortcode-css' );
